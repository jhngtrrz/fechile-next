...
export function Hero() {
  return (
    <section className="w-full py-6 md:py-12 lg:py-24 xl:py-32 bg-muted flex justify-center">
      <div className="container px-4 md:px-6 flex items-center">
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          <div className="flex items-center justify-center">
            <iframe
              className="w-full h-[315px] md:h-[420px] lg:h-[480px] xl:h-[480px] overflow-hidden rounded-xl object-cover object-center pointer-events-none"
              src="https://www.youtube-nocookie.com/embed/c3JdYEAoj0Y?autoplay=1&mute=1&controls=0&loop=1&playlist=c3JdYEAoj0Y&modestbranding=1&playsinline=1&fs=0&iv_load_policy=3&disablekb=1"
              frameBorder="0"
